...
void CAlphaO02Dlg::OnLoad(void)
{
	...
	// m_dol_log에 있는 인덱스들의 리스트값들을 dol_log_copy로 옮기기



	// CString으로 받은 win_log 에서 백승리수 흑승리수 찾기
	white_win_count = GetFindCharCount(GetTextListBox(), 'H');
	black_win_count = GetFindCharCount(GetTextListBox(), 'B');
